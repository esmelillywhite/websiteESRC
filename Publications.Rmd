...
Klein, M., & Sosu, M. (in press). School attendance and academic achievement: Understanding variation across family socioeconomic status. Sociology of Education
...
Jascha Dräger, Markus Klein, Edward Sosu. The long-term consequences of school absences for educational and labour market outcomes. *Under review.* A preprint can be accessed [here](https://edarxiv.org/7z2bx/).

Markus Klein and Edward Sosu. School absences, educational achievement, and adolescents’ post-school destinations – Evidence from Scotland. *Under review.*

Jascha Dräger, Markus Klein, Edward Sosu.School absences trajectories and their consequences for educational achievement. *In preparation for submission.* A preprint can be accessed [here](https://edarxiv.org/ch4jq/).

Jascha Dräger, Markus Klein, Edward Sosu. Timing of absences and academic achievement - A comparison of England and Wales. *In progress.*
